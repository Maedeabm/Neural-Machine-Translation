...
utils.check_language_file_availability(args.language)
...
# Save our models
torch.save(encoder.state_dict(), 'encoder_params_{}'.format(args.language))
torch.save(decoder.state_dict(), 'decoder_params_{}'.format(args.language))
torch.save(decoder.attention.state_dict(), 'attention_params_{}'.format(args.language))
